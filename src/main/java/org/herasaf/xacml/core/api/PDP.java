 ...
 * Point.<br />
 * A PDP is responsible for evaluating authorization requests against the
 * deployed policies from a PolicyRepository. <br />
 * <br />
 * The PDP evaluates a request ({@link RequestCtx}) against all policies
 * retrieved from the Policy Repository, evaluates them and returns a response
 * inlcuding the decision <br />
 * It can use a PIP (Policy Information Point) if missing attributes should be
 * resolved during evaluation.<br />
 * A PDP has a root Policy Combining Algorithm configured that is responsible
 * for combining decisions in case multiple policies matched. <br />
 * <br />
 * XACML specifies: The Policy Decision Point is used to evaluate access control
 * requests. For further information see <a href=
 * "http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20">
 * OASIS eXtensible Access Control Markup Langugage (XACML) 2.0, Errata 29 June
 * 2006</a>.
 * 
 * @see {@link PolicyRepository}, {@link PIP}, {@link RequestCtx},
 *      {@link ResponseCtx}
 * 
...
public interface PDP {
	 ...
	 * missing attributes. The {@link PIP} is an optional component so it may be
	 * <code>null</code>.<br />
	...
	/**
	 * Returns the {@link PolicyCombiningAlgorithm} that this PDP uses for
	 * evaluation. This {@link CombiningAlgorithm} combines the evaluation
	 * results on the root level.
	 * 
