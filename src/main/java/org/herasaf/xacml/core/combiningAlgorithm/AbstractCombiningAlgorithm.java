...
/**
 * This abstraction may be extended. It has implemented common logic that is valid for all combining algorithms within
 * the PDP.
 * 
...
public abstract class AbstractCombiningAlgorithm implements CombiningAlgorithm {
    ...
    protected TargetMatchingResult matchTarget(final RequestType request, final TargetType target,
        ...
        try {
            ...
            /*
             * See: OASIS eXtensible Access Control Markup Langugage (XACML) 2.0, Errata 29. January 2008</a> pages
             * 93-94 chapter Policy evaluation for further information.
             */
