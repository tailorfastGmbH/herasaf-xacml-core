...
/**
 * All rule combining algorithms must implement this interface. It provides the entry point (
 * {@link #evaluateRuleList(RequestType, List, EvaluationContext)} ) for starting to evaluate all containing rules and a
 * method to evaluate a single rule ({@link #evaluateRule(RequestType, RuleType, EvaluationContext)} ).
 * 
 * @author Sacha Dolski
...
public interface RuleCombiningAlgorithm {
     ...
     * Evaluates a rule.
     * 
     * The different return values of a rule evaluation are specified in the XACML 2.0 specification. See: <a href=
     * "http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20" > OASIS eXtensible Access Control
     * Markup Langugage (XACML) 2.0,Errata 29. January 2008</a> page 93 for further information.
     * 
     * @param request
    ...
    /**
     * Evaluates all rules given in the rule list and returns the combined result.
     * 
     * @param request
