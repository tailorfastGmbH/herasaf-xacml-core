...
/**
 * This class may be extended when implementing an ordered rule combining algorithm. It contains some common code all
...
public abstract class RuleOrderedCombiningAlgorithm extends AbstractRuleCombiningAlgorithm {
    ...
    public DecisionType evaluate(final RequestType request, final Evaluatable evals,
        ...
        try {
            ...
            final DecisionType dec = this.evaluateRuleList(request, ((PolicyType) evals).getOrderedRules(),
                    evaluationContext);
            /*
