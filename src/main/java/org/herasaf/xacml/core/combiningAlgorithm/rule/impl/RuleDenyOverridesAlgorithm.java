...
/**
 * The implementation of the default XACML 2.0 <i>rule unordered deny overrides
 * algorithm</i>.<br />
 * See: <a href=
 * "http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20">
 * OASIS eXtensible Access Control Markup Langugage (XACML) 2.0, Errata 29.
 * January 2008</a> pages 146-148, for further information.
 * 
 * @author Sacha Dolski
...
public class RuleDenyOverridesAlgorithm extends RuleUnorderedCombiningAlgorithm {
	...
	public DecisionType evaluateRuleList(final RequestType request,
		...
		if (potentialDeny) {
			/*
			 * The status of the evaluationContext has to be reset to go sure
			 * that only the wanted values are setted.
			 */
			evaluationContext.resetStatus();
