 ...
 * @version 1.0
 */
public class Base64BinaryBagSizeFunction extends AbstractBagSizeFunction<Base64Binary> {

	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-bag-size";
