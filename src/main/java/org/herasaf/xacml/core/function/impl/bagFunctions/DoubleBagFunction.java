...
/**
 * <p>
 * The implementation of the urn:oasis:names:tc:xacml:1.0:function:double-bag
 * function.
 * </p>
 * <p>
...
public class DoubleBagFunction extends AbstractBagFunction<Double> {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:double-bag";
