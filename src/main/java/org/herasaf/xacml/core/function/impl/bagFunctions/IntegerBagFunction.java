...
/**
 * <p>
 * The implementation of the urn:oasis:names:tc:xacml:1.0:function:integer-bag
 * function.
 * </p>
 * <p>
...
public class IntegerBagFunction extends AbstractBagFunction<BigInteger> {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:integer-bag";
