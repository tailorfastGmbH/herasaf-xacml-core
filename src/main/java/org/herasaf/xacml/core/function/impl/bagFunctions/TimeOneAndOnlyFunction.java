 ...
 */
public class TimeOneAndOnlyFunction extends AbstractOneAndOnlyFunction<OffsetDateTime> {

	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:time-one-and-only";
