 ...
 * @version 1.0
 */
public class DateTimeEqualFunction implements Function {
	/**
	 *
	 */
	private static final long serialVersionUID = 2335773743966232436L;
	private static final String ID = "urn:oasis:names:tc:xacml:1.0:function:dateTime-equal";

	/**
	 * {@inheritDoc}
	 *
	 * Takes two {@link DateTime} objects as parameters and returns wheter they are
