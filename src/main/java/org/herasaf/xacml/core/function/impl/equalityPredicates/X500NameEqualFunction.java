...
/**
 * The implementation of the urn:oasis:names:tc:xacml:1.0:function:x500Name-equal function.
...
public class X500NameEqualFunction implements Function {
	 ...
	 * {@inheritDoc}
	 *
	 * Takes two {@link X500Principal} objects as parameters and returns wheter they are
