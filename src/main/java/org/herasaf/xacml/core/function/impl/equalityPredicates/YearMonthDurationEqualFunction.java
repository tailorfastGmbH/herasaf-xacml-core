...
/**
 * The implementation of the urn:oasis:names:tc:xacml:1.0:function:yearMonthDuration-equal function.
 ...
 * @version 1.0
 */
public class YearMonthDurationEqualFunction implements Function {
	/**
	 *
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * Takes two {@link YearMonthDuration} objects as parameters and returns wheter they are
