...
public class DateGreaterThanOrEqualFunction extends AbstractFunction {
	...
	private final Logger logger = LoggerFactory.getLogger(DateGreaterThanOrEqualFunction.class);
	 ...
	 * function function urn:oasis:names:tc:xacml:1.0:function:date-greater-than-or-equal page 121.
	 * 
