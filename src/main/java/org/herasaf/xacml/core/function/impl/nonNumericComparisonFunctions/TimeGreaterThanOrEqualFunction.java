 ...
 * @version 1.0
 */
public class TimeGreaterThanOrEqualFunction implements Function {
	private static final long serialVersionUID = -8657888777873703249L;
	private static final String ID = "urn:oasis:names:tc:xacml:1.0:function:time-greater-than-or-equal";
	 ...
	 * page 114 function urn:oasis:names:tc:xacml:1.0:function:time-greater-than-or-equal
	...
	// page 113 function
	// urn:oasis:names:tc:xacml:1.0:function:time-greater-than-or-equal is
