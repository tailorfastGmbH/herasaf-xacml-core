 ...
 * urn:oasis:names:tc:xacml:1.0:function:integer-greater-than function.
 * </p>
 * <p>
...
public class IntegerGreaterThanFunction extends AbstractFunction {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:integer-greater-than";
	 ...
	 * {@inheritDoc} <br>
	 * <br>
	 * Returns true if the first argument of type integer is greater than the
	 * second argument.
	 */
