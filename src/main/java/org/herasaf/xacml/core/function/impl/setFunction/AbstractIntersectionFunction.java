...
/** <p>The implementation of the urn:oasis:names:tc:xacml:1.0:function:<u>type</u>-intersection function.</p>
...
* @version 1.0
*/
public abstract class AbstractIntersectionFunction<T> implements Function {
	private static final long serialVersionUID = -367894928512846701L;

	/**
	 * {@inheritDoc}
	 * <br><br>
	 * Returns a bag containing all elements that are common in the first and the second bag.
	 */
