...
/** <p>The implementation of the urn:oasis:names:tc:xacml:1.0:function:<u>type</u>-set-equals function.</p>
...
* @version 1.0
*/
public abstract class AbstractSetEqualsFunction<T> implements Function {
	private static final long serialVersionUID = -367894928512846701L;

	/**
	 * {@inheritDoc}
	 * <br><br>
	 * Returns true if the first argument set and the second argument set are equal.
	 */
	...
	public Object handle(Object... args) throws FunctionProcessingException {
		try {
			...
			boolean result1 = ((List<T>)args[1]).containsAll((List<T>)args[0]);
			if (!result1){
				return result1;
			}
