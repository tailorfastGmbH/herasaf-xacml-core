 ...
 * urn:oasis:names:tc:xacml:1.0:function:boolean-set-equals function.
 * </p>
 * <p>
...
public class BooleanSetEqualsFunction extends AbstractSetEqualsFunction<Boolean> {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:boolean-set-equals";
