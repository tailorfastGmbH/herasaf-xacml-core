 ...
 */
@XmlRootElement(name = "Environments", namespace="urn:oasis:names:tc:xacml:2.0:policy:schema:os")
...
public class EnvironmentsType implements Serializable {
	...
	private List<EnvironmentType> environments;
	 ...
	 * <CODE>set</CODE> method for the environments property.
	 * 
	 * <p>
