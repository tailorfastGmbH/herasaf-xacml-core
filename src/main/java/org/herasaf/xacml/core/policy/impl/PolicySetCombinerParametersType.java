 ...
 * OASIS eXtensible Access Control Markup Langugage (XACML) 2.0, Errata, 29 January 2008</a> page 60, for further information.
 * 
 * @author <i>generated</i>
 */
@XmlRootElement(name = "PolicySetCombinerParameters", namespace="urn:oasis:names:tc:xacml:2.0:policy:schema:os")
