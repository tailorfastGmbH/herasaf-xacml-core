...
/**
 * Tests if the AllOfAny (higher order) function works properly.
 * 
 * @author Florian Huonder
 */
public class TestAllOfAnyFunction {
	private Function function;
	private Function compareFunction;

	/**
	 * Initializes the compare function needed to pass to the AllOfAny (higher order) function.
	 * Initializes the AllOfAny (higher order) function.
	 */
	@BeforeTest
	public void beforeTest() {
		this.function = new AllOfAnyFunction();
