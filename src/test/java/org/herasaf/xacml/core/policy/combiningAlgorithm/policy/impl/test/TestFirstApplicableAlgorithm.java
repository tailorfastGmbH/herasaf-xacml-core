...
public class TestFirstApplicableAlgorithm extends AbstractTestNGSpringContextTests{
	...
	public Object[][] testPolicyCombinations() throws Exception {
		return new Object[][] {
				...
				new Object[] {
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate missing Attribute, Permit. Result: Indeterminate",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.MISSING_ATTRIBUTE,
						...
						DecisionType.INDETERMINATE },
				new Object[] {
						"Indeterminate Processing Error, Permit. Result: Indeterminate",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.PROCESSING_ERROR, null),
						...
						DecisionType.INDETERMINATE },
				new Object[] {
						"Indeterminate syntax error, Permit. Result: Indeterminate",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.SYNTAX_ERROR, null),
	...
	public void beforeTest() {
		...
		combAlg = new PolicyFirstApplicableAlgorithm();
