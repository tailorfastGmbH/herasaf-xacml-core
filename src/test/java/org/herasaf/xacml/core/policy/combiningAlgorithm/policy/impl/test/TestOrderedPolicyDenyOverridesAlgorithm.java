...
public class TestOrderedPolicyDenyOverridesAlgorithm extends AbstractTestNGSpringContextTests{
	...
	public Object[][] testPolicyCombinations() throws Exception {
		return new Object[][] {
				...
				new Object[] {
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Deny Missing Attr. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Indeterminate missing attr. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Indeterminate processing error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Indeterminate Syntax error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
				...
				new Object[] {
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate missing Attribute, Permit. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.MISSING_ATTRIBUTE,
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate Processing Error, Permit. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.PROCESSING_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate syntax error, Permit. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.SYNTAX_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate missingAttribute, Indeterminate Missing Attribute. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.MISSING_ATTRIBUTE,
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate missing Attribute, Indeterminate Processing Error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.MISSING_ATTRIBUTE,
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate missing Attribute, Indeterminate syntax error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.MISSING_ATTRIBUTE,
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate processing error, Indeterminate processing error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.PROCESSING_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate processing error, Indeterminate syntax error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.PROCESSING_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate syntax error, Indeterminate syntax error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.SYNTAX_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate missing Attribute, Not applicable. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.MISSING_ATTRIBUTE,
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate processing error, Not applicable. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.PROCESSING_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Indeterminate syntax error, Not applicable. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.INDETERMINATE,
										StatusCode.SYNTAX_ERROR, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Not Applicable, Permit. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.NOT_APPLICABLE,
										StatusCode.OK, null),
				...
				new Object[] {
						...
						DecisionType.DENY },
				new Object[] {
						"Not Applicable, Permit missing attribute. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.NOT_APPLICABLE,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Not Applicable, Indeterminate missing attribute. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.NOT_APPLICABLE,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Not Applicable, Indeterminate processing error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.NOT_APPLICABLE,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Not Applicable, Indeterminate syntax error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.NOT_APPLICABLE,
										StatusCode.OK, null),
				...
				new Object[] {
						"Permit, Deny, NotApplicable. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Deny OK, NotApplicable. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Deny OK, Indeterminate Missing Attribute. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Deny , Indeterminate Processing Error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY },
				new Object[] {
						"Permit, Deny missing Attribute, Indeterminate Syntax Error. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
	...
	public void beforeTest() {
		...
		combAlg = new PolicyOrderedDenyOverridesAlgorithm();
...
//					statusCode = algMock.statusCode;
//						details.add(algMock.missingAttr);
//					if (statusCode == StatusCode.PROCESSING_ERROR || statusCode == StatusCode.SYNTAX_ERROR){
//						details.clear();
//						break;
//					}
//				}
...
//			break;
		...
		assertEquals(reqEvals.getStatusCode(), statusCode);
