...
public class TestPolicyDenyOverridesAlgorithm extends AbstractTestNGSpringContextTests{
	...
	public Object[][] testPolicyCombinations() throws Exception {
		return new Object[][] {
				...
				new Object[] {
						...
						DecisionType.DENY, StatusCode.OK },
				new Object[] {
						"Permit, Deny missing Attribute, NotApplicable. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
						...
						DecisionType.DENY, StatusCode.OK },
				new Object[] {
						"Permit, Deny missing Attribute, Indeterminate Missing Attribute. Result: Deny",
						new PolicyCombiningAlgMock[] {
								new PolicyCombiningAlgMock(
										DecisionType.PERMIT,
										StatusCode.OK, null),
	...
	public void beforeTest() {
		...
		combAlg = new PolicyDenyOverridesAlgorithm();
...
//				}
		...
		assertEquals(reqEvals.getStatusCode(), code);
