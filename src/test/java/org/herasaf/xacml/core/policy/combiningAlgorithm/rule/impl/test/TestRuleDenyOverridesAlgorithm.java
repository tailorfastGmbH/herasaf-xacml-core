...
public class TestRuleDenyOverridesAlgorithm extends AbstractTestNGSpringContextTests{
	...
	public TestRuleDenyOverridesAlgorithm() {
		...
		for (int i = 0; i < ruleDenyOverridesAlgorithmWithTRUEDecisionsArray.length; i++) {
			...
			ruleDenyOverridesAlgorithmWithTRUEDecisionsArray[i].setTargetMatcher(new TargetMatcherMock(
		...
		ruleDenyOverridesAlgorithmWithTRUEFALSEDecisions.setTargetMatcher(new TargetMatcherMock(
				new TargetMatcherMock.Decisions[] {
						TargetMatcherMock.Decisions.TRUE,
