...
/**
 * <p>
 * The implementation of the urn:oasis:names:tc:xacml:1.0:function:dateTime-greater-than function.
 * </p>
 * <p>
 * See: Apendix A.3 of the <a href= "http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20"> OASIS
 * eXtensible Access Control Markup Langugage (XACML) 2.0, Errata, 29 January 2008</a> page 118, for further
 * information.
 * </p>
 * 
...
public class DateTimeGreaterThanFunction extends AbstractFunction {
	 ...
	 * {@inheritDoc} <br>
	 * <br>
	 * Returns true if the first argument of type http://www.w3.org/2001/XMLSchema#dateTime is greater than the second
	 * argument.<br>
	 * * <br>
	 * <br>
	 * OASIS eXtensible Access Control Markup Langugage (XACML) 2.0, Errata 29 January 2008 <a href=
	 * "http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20"
	 * >http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20 </a> function
	 * urn:oasis:names:tc:xacml:1.0:function:dateTime-greater-than page 120.
	 * 
