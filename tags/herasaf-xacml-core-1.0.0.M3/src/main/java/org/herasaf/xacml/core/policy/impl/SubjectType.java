 ...
 * OASIS eXtensible Access Control Markup Langugage (XACML) 2.0, Errata, 29 January 2008</a> page 49, for further information.
 * 
 * @author <i>generated</i>
 */
@XmlRootElement(name = "Subject", namespace="urn:oasis:names:tc:xacml:2.0:policy:schema:os")
@XmlType(name = "SubjectType", propOrder = { "subjectMatches" })
public class SubjectType implements Serializable {
	 ...
	 * <CODE>set</CODE> method for the subjectMatches property.
	 * 
	 * <p>
