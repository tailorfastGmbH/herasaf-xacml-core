 ...
 * @version 1.0
 */
public class DoubleMultiplyFunction extends AbstractFunction {

	private static final long serialVersionUID = -5174374756689896670L;
	private static final String ID = "urn:oasis:names:tc:xacml:1.0:function:double-multiply";
