 ...
 * urn:oasis:names:tc:xacml:1.0:function:x500Name-equal function. See: Apendix
 * A.3 of the <a href=
...
public class X500NameEqualFunction extends AbstractFunction {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:x500Name-equal";
	 ...
	 * {@inheritDoc}
	 * 
	 * Takes two {@link X500Principal} objects as parameters and returns wheter
