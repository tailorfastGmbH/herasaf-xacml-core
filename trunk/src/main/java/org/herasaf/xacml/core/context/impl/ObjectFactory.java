 ...
 * element interface generated in the org.herasaf.core.context package.
 * <p>
...
public class ObjectFactory {
	...
	private static final QName _Environment_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"Environment");
	private static final QName _Subject_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os", "Subject");
	private static final QName _StatusDetail_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"StatusDetail");
	private static final QName _MissingAttributeDetail_QNAME = new QName(
	...
	private static final QName _ResourceContent_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"ResourceContent");
	...
	private static final QName _Attribute_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"Attribute");
	private static final QName _Result_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os", "Result");
	private static final QName _AttributeValue_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"AttributeValue");
	private static final QName _StatusCode_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"StatusCode");
	private static final QName _StatusMessage_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:context:schema:os",
			"StatusMessage");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.herasaf.core.context.
	 * 
	 */
