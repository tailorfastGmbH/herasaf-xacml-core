 ...
 * @version 1.0
 */
public class DayTimeDurationOneAndOnlyFunction extends AbstractOneAndOnlyFunction<DayTimeDuration> {

	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:dayTimeDuration-one-and-only";
