 ...
 * urn:oasis:names:tc:xacml:1.0:function:string-greater-than function.
 * </p>
 * <p>
...
public class StringGreaterThanFunction extends AbstractFunction {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:string-greater-than";
	 ...
	 * http://www.w3.org/2001/XMLSchema#string is greater than the second
	 * argument.
	 */
