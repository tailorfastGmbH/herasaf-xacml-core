 ...
 * urn:oasis:names:tc:xacml:1.0:function:time-less-than-or-equal function.
 * </p>
 * <p>
...
public class TimeLessThanOrEqualFunction extends AbstractFunction {
	...
	/** XACML function ID. */
	public static final String ID = "urn:oasis:names:tc:xacml:1.0:function:time-less-than-or-equal";
	 ...
	 * http://www.w3.org/2001/XMLSchema#time is lesser than or equal the second
	 * argument.<br>
	 * * <br>
	 ...
	 * page 114 function urn:oasis:names:tc:xacml:1.0:function:time-less-than-or-equal
	...
	// (http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=xacml#XACML20)
	// page 113 function
	// urn:oasis:names:tc:xacml:1.0:function:time-less-than-or-equal is
