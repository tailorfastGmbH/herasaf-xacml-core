 ...
 */
@XmlRootElement(name = "Subjects", namespace="urn:oasis:names:tc:xacml:2.0:policy:schema:os")
@XmlType(name = "SubjectsType", propOrder = { "subjects" })
public class SubjectsType implements Serializable {
