...
/**
 * Tests if the AnyOfAll (higher order) function works properly.
 * 
 * @author Florian Huonder
 */
public class TestAnyOfAllFunction {
	private Function function;
	private Function compareFunction;

	/**
	 * Initializes the compare function needed to pass to the AnyOfAll (higher order) function.
	 * Initializes the AnyOfAll (higher order) function.
	 */
	@BeforeTest
	public void beforeTest() {
		this.function = new AnyOfAllFunction();
